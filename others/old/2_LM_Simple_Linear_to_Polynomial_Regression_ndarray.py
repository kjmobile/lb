...
# - Try higher-degree polynomials (degree 4, 5)
# - Learn about `sklearn.preprocessing.PolynomialFeatures` for automatic feature creation
# 
# Great job! You now understand regression with both DataFrames AND arrays! 🎉
